...
function scoreboard(inningCB, _InningCB, numInnings) {
  const scoreByInning = [];
  let homeScore = 0;
  let awayScore = 0;
  ...
  if(homeScore == awayScore){ 
    scoreByInning.push('This gane will require extra innings: Away ${currentinning.Away} - Home ${currentInning.Home}');
  }else{
